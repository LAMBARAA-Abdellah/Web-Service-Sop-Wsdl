...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "ConvertToDirham", targetNamespace = "http://ws/", className = "proxy.ConvertToDirham")
    @ResponseWrapper(localName = "ConvertToDirhamResponse", targetNamespace = "http://ws/", className = "proxy.ConvertToDirhamResponse")
    @Action(input = "http://ws/BanqueService/ConvertToDirhamRequest", output = "http://ws/BanqueService/ConvertToDirhamResponse")
    public double convertToDirham(
